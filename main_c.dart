...
import 'module_c/api.dart';
import 'module_c/app.dart';
import 'module_c/app_state.dart';
...
Future<void> main() => startModuleC();

Future<void> startModuleC([String baseUrl = defaultBaseUrl]) async {
